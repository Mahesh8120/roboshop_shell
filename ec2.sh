...
SG_ID="sg-0b26f0054692962c9" # replace with your SG ID
ZONE_ID="Z09532653LYSJAOMBYJTE" # replace with your ID
...
do
    ...
    if [ $instance != "frontend" ]; then
        ...
        RECORD_NAME="$instance.$DOMAIN_NAME" # mongodb.sitaram.icu
    else
        IP=$(aws ec2 describe-instances --instance-ids $INSTANCE_ID --query 'Reservations[0].Instances[0].PublicIpAddress' --output text)
        RECORD_NAME="$DOMAIN_NAME" # sitaram.icu
    fi
